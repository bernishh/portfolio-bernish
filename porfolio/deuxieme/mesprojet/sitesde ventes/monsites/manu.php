        ...
        <div class = "container">
            ...
            <div class = "collapse navbar-collapse order-lg-1" id = "navMenu">
                <ul class = "navbar-nav mx-auto text-center">
                    ...
                    <li class = "nav-item px-2 py-2">
                        <a class = "nav-link text-uppercase text-dark" href = "inscriadmin.php">Ajout admin</a>
                    </li>
...
<?php 
    ...
    if(isset ($_POST['valider']))
    {
        ...
        if (isset($_FILES['image']) AND isset($_POST['nom']) AND isset($_POST['prix']) AND isset($_POST['desc']))
        {
            if (!empty($_FILES['image']) AND !empty($_POST['nom']) AND!empty($_POST['prix']) AND!empty($_POST['desc']))
            {
                // AjoutImage
                $time = time();
                $image = $time . ".jpg";
                $chemin = "images/produits/" . $image;
               ...
               try
               {
                  ...
                  echo("<h2 class='alert'>Article ajouté avec succès!</h2>");
               } catch (Exeption $e) 
               {
                $e->getMessage();
               }
